...
const experience = [
  {
    ...
    highlights: [
      ...
      "Established a Business Analysis Community of Practice, strengthening collaboration, reusable practices, knowledge sharing and consistency across the BA function.",
    ],
    tags: [
      "Business Analysis",
      "Digital Health",
